...
import type { SubjectRecord } from './useSubjects';
import layoutStyles from '../../shared/layout.module.css';

interface SubjectProfileViewProps {
  subject: SubjectRecord;
  onBack: () => void;
}

export const SubjectProfileView: React.FC<SubjectProfileViewProps> = ({ subject, onBack }) => {
  return (
    <div className={layoutStyles.studentsContainer}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
        ...
        <h1 style={{ margin: 0, fontSize: '1.8rem', fontWeight: 700 }}>Subject Profile</h1>
      </div>
