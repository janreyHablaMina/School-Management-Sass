...
import { FilterSelect, listStyles, modalStyles, PageHeader } from '@/components/Teacher/shared';
...
export function SettingsView({ onProfileSave }: SettingsViewProps) {
  ...
  return (
    <div className={listStyles.page}>
      <PageHeader
        title="Settings"
        subtitle="Manage your profile, notifications, and system preferences."
      >
      ...
      <div className={styles.layout}>
        ...
        <div className={styles.content} key={section}>
            ...
            >
              <div className={styles.avatarCard}>
                ...
                <div className={styles.avatarMeta}>
                  ...
                  <span className={styles.avatarRole}>{profile.role || 'School Administrator'}</span>
          ...
          {section === 'Notifications' ? (
            <SettingsSection
              title="Notifications"
              description="Choose which school updates should reach you."
            >
          ...
          {section === 'Preferences' ? (
            <SettingsSection
              title="Preferences"
              description="Set defaults that speed up your daily administrative flow."
            >
              <div className={styles.fieldGrid}>
                <FilterSelect
                  label="Landing tab"
